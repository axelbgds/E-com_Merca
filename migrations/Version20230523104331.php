 ...
 */
final class Version20230523104331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE products (id INT NOT NULL, categories_id INT NOT NULL, promotion_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, price INT NOT NULL, stock INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, slug VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_B3BA5A5AA21214B7 ON products (categories_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B3BA5A5A139DF194 ON products (promotion_id)');
        $this->addSql('COMMENT ON COLUMN products.created_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE promotions (id INT NOT NULL, start_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, end_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, promotion_disc INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE products ADD CONSTRAINT FK_B3BA5A5A139DF194 FOREIGN KEY (promotion_id) REFERENCES promotions (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products DROP CONSTRAINT FK_B3BA5A5A139DF194');
